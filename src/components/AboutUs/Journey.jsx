...
const Journey = () => {
  return (
    <div className="w-full flex flex-col items-center py-16 md:py-24 px-4 sm:px-8 lg:px-24">
      <h2 className="text-4xl md:text-7xl font-semibold text-gray-900 mb-12">
        Our Journey
      </h2>
      ...
      <div className="flex items-center justify-center">
        {journeyData.map((item, index) => (
          <React.Fragment key={index}>
            {/* Card */}
            <div
              className={`bg-white rounded-2xl p-8 w-[320px] text-center relative z-10 shadow-sm ${
                item.highlight ? "border-[1.5px] border-primary shadow-[0_4px_20px_rgba(214,58,213,0.15)]" : "border-[1.5px] border-gray-200"
              }`}
            >
              {/* Icon */}
