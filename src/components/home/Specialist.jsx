...
const Specialist = () => {
  return (
    <section className="bg-[#f5e6f5] w-full rounded-xl sm:rounded-2xl py-10 sm:py-14 px-4 sm:px-8 mt-20 sm:mt-32">
      <h2 className="text-4xl sm:text-4xl lg:text-6xl xl:text-[80px] font-semibold text-center text-gray-900 mb-5 sm:mb-7 leading-tight">
      ...
      <Link
        href="/our-products"
        className="bg-primary text-white w-fit flex justify-center items-center gap-2 sm:gap-3 rounded-[22.4px] py-[5.6px] pl-[16.8px] pr-[5.6px] mx-auto"
      >
        <h1 className="text-m sm:text-[18px] font-light">Explore Products</h1>
