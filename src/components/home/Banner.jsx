  ...
  return (
    <div className="relative w-full h-100 sm:h-125 md:h-150 lg:h-200 overflow-hidden rounded-2xl md:rounded-4xl">
      ...
      <div className="absolute inset-0 flex flex-col justify-center text-left px-4 sm:px-6 md:pl-24 md:pr-16 w-full">
        <h1 className="text-white text-[38px] sm:text-4xl md:text-5xl lg:text-[82px] font-medium mb-2 sm:mb-3 md:mb-4 w-full max-w-full md:max-w-4xl">
          Leading the Future <br /> of Animal Health
        </h1>
        <p className="text-white text-[15px] md:text-[18px] font-light mb-5 sm:mb-4 md:mb-6 leading-relaxed w-full md:max-w-xl">
