  ...
  return (
    <>
      <div className="mb-6 md:mb-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-0">
        <h2 className="text-[2xl] xs:text-[32px] sm:text-4xl md:text-5xl lg:text-7xl font-semibold text-[#232323] wrap-break-word md:whitespace-nowrap font-[family-name:--font-gilroy]">Explore Our Products</h2>
