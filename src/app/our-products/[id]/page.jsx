          ...
          <div className="col-span-1 lg:col-span-6 space-y-6">
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex flex-wrap gap-2.5">
                <button className="px-4 py-2 border border-gray-200 rounded-xl font-bold text-sm text-[#444444] bg-[#f5e6f5] transition-all duration-200 shadow-sm">
                  1 Litre
                </button>
                <button className="px-4 py-2 border border-gray-200 rounded-xl font-bold text-sm text-[#444444] bg-[#f5e6f5] transition-all duration-200 shadow-sm">
                  5 Litre
            ...
            <div className="space-y-2 pt-4">
              <div className="collapse collapse-plus border-t border-primary">
              ...
              <table className="table w-full text-sm text-[#444444]">
                ...
                <tbody className="divide-y divide-base-200 font-medium">
                  <tr className="hover:bg-base-200/20 transition-colors">
                    ...
                    <td className="py-3 px-4 text-right text-[#232323] font-bold">
                      2000 mg.
                    </td>
                  </tr>
                  <tr className="hover:bg-base-200/20 transition-colors">
                  ...
                  <tr className="hover:bg-base-200/20 transition-colors">
                    ...
                    <td className="py-3 px-4 text-right text-[#232323] font-bold whitespace-nowrap">
                      3.3 mcg.
                    </td>
                  </tr>
                </tbody>
