...
const NotFoundPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f5e6f5] px-4">
      <div className="max-w-lg w-full text-center bg-white shadow-lg rounded-2xl p-8">
        {/* Icon */}
        <div className="flex justify-center mb-6">
          <div className="h-16 w-16 rounded-full bg-blue-100 flex items-center justify-center text-primary text-2xl font-bold">
            404
          </div>
        </div>
        ...
        <p className="mt-8 text-sm text-gray-500">
          Together for healthier poultry, stronger farming.
        </p>
      </div>
    </div>
  );
